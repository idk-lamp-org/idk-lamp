// src/idk-lamp.js
class IdkLamp extends HTMLElement {
  ...
  attributeChangedCallback(name, oldValue, newValue) {
    ...
    if (name === "state") this._updateState();
    if (name === "interactive") this._syncInteractivity();
  }
  ...
  _syncInteractivity() {
    if (this.hasAttribute("interactive")) this._attachInteractivity();
    else this._detachInteractivity();
  }

  _attachInteractivity() {
    if (this._interactiveAttached) return;
